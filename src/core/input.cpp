...
namespace swav {
	...
	void LoopbackInput::loopback(ma_device* pDevice, void* pOutput, const void* pInput, ma_uint32 frameCount) {
		const Context& globalContext = getGlobalContext();
	...
	void LoopbackInput::staticLoopback(ma_device* pDevice, void* pOutput, const void* pInput, ma_uint32 frameCount) {
	...
	void CaptureInput::loopback(ma_device* pDevice, void* pOutput, const void* pInput, ma_uint32 frameCount) {
		const Context& globalContext = getGlobalContext();
		for (std::shared_ptr<Output> output : globalContext.outputs) {
			output->write(pInput, frameCount);
		}
	...
	void CaptureInput::staticLoopback(ma_device* pDevice, void* pOutput, const void* pInput, ma_uint32 frameCount) {
